...
public class ModuleManager {
    ...
    public ModuleManager() {
        try {
            ...
            if (navenInstance != null && navenInstance.getEventManager() != null) {
                navenInstance.getEventManager().register(this);
            }
            
            // 初始化模块
            this.initModules();
            
            // 排序模块（使用原始名称避免调用 getName()）
            this.modules.sort((o1, o2) -> o1.getEnName().compareToIgnoreCase(o2.getEnName()));
